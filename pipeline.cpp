...
void Pipeline::InitScaleTransform(glm::mat4x4& m) const{
...
void Pipeline::InitRotateTransform(glm::mat4x4& m) const {
    glm::mat4x4  rx, ry, rz;
...
void Pipeline::InitTranslationTransform(glm::mat4x4& m) const
{
